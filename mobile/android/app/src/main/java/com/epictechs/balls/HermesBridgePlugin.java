...
@CapacitorPlugin(name = "HermesBridge")
public class HermesBridgePlugin extends Plugin {
    ...
    public void getStatus(PluginCall call) {
        ...
        boolean serviceConnected = HermesAccessibilityService.isConnected();
    ...
    private boolean isAccessibilityEnabled() {
        ...
        for (AccessibilityServiceInfo service : services) {
            ...
            if (getContext().getPackageName().equals(resolveInfo.serviceInfo.packageName)
                    && HermesAccessibilityService.class.getName().equals(resolveInfo.serviceInfo.name)) {
                return true;
            }
        }
        return false;
